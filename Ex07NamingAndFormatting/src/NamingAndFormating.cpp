...
// 3. Starting with an underscore is legal but should be avoided (these names
//    are usually used by the OS, library, or compiler).
...
// * Identifier that represents a non-specific number can have a shorter name
...
int main()
{
    ...
    // C++ is whitespace independent. The following two statements are
    // equivalent.
